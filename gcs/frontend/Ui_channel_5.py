...
class Ui_channel_5(object):
    def setupUi(self, channel_5):
        ...
        channel_5.resize(234, 267)
        channel_5.setMinimumSize(QtCore.QSize(234, 267))
        channel_5.setStyleSheet("background-color: rgb(238, 238, 236);")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(channel_5)
        ...
        self.fields = channel_widget(self.frame)
        self.fields.setMinimumSize(QtCore.QSize(220, 220))
        self.fields.setMaximumSize(QtCore.QSize(400, 270))
